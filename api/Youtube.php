...
class Youtube
{
    ...
    var $APIs = array(
        ...
        'videos.search' => 'https://www.googleapis.com/youtube/v3/search',
    );
     ...
     * @return \StdClass
     * @throws \Exception
     * GET https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCd8tHv1A1VsTL7WS9yQ3eGg
     * order can by: date, rating, relevance, title, videoCount, viewCount
     */
    public function getVideosByChannelId($channelId, $order='date', $maxResults=50)
    {
        if( !$channelId ) return null;
        $API_URL = $this->getApi('videos.search');
        $params = array(
            'channelId' => $channelId,
